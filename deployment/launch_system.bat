...
REM Open frontend automatically
echo.
echo Opening frontend interface...
echo Opening fracture_frontend.html...
start "" "fracture_frontend.html"
